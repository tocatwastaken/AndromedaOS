...
if (type(path) ~= "string") then
    _G.Darwin.Logger:Msg("Fatal: Invalid path! Expected string, got " .. type(path))
    return
end
...
if not fs.exists(path) then
    _G.Darwin.Logger:Msg("Fatal: App doesn't exist!")
    _G.Darwin.Logger:Msg("Couldn't find: " .. path)
    return
end
